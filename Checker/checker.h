...
/*   Updated: 2017/05/17 16:12:32 by vboiko           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void					ft_get_data
						(t_arr **arr_a, char *str);
void					ft_create_elem
						(t_arr **arr_a, long long int nb);
void					ft_error
						(int err);
int						ft_ifnumber
						(char *str);
...
void					ft_input_validation
						(t_arr **arr);
int						ft_lstlen
						(t_arr **arr);
int						ft_read_commands
						(t_arr **arr_a, t_arr **arr_b, int cl);
void					ft_read_commands_dbg
						(t_arr **arr_a, t_arr **arr_b);
void					ft_print_arr
						(t_arr **arr_a, t_arr **arr_b);
int						ft_get_command
